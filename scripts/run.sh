...
python ../train_distillation.py -r 0.5 -a 0.5 --path_t ../save/model/teacher/mini_distilled.pth --trial born1 --model_path ../save/model/ckpt  --data_root ../save/data/CIFAR-FS
